...
The FastAPI application exposes the analytics API under `/api`, serves the frontend when available, and provides a `/health` endpoint for service monitoring. fileciteturn10file0L2-L2
